<form action="{{ route('extension-report.store') }}" method="POST" enctype="multipart/form-data" role="form">
	<div class="row">
		<div class="col-md-6">
		...
		<div class="col-md-6">
			<div class="form-group">
				<label>Photos</label>
				<input type="file" id="input-file-now" class="defaultdropify" name="file[]" data-allowed-file-extensions="JPEG jpg png" multiple required>
			</div>
		</div>
	</div>
