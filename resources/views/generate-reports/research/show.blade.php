...
@section('content')
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 id="reportTitle" class="h3 mb-0 text-gray-800" data-textval="Research-{{ $card->card_name." FY ".$card->fiscal_year }} Reports">Research-{{ $card->card_name." FY ".$card->fiscal_year }}</h1>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#researchReportsDataTable').DataTable({
				...
				"serverSide": false,
				"ajax":{
					"url": "{{ route('research-report-data',$card->id) }}",
					"type": "GET"
				},
				columns: [
			    	{ "data": "id" },
				...
				initComplete: function () {
					this.api().columns([0,1,3,4,5,6,8,9,11]).every( function () {
						var column = this;
