...
class ExtensionReportPhotoController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ExtensionReportPhoto $user_extension_reports_photo)
    {
        File::delete($this->photo_path.$user_extension_reports_photo->photo);
        $user_extension_reports_photo->delete();
